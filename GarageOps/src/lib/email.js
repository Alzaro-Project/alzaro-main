...
const EMAIL_CONFIG = {
  ...
  FROM_NAME: import.meta.env.VITE_FROM_NAME || 'Alzaro GarageOps',
}
...
export const SMTP_CONFIG = {
  ...
  // Sender Details
  from: {
    name: import.meta.env.VITE_SMTP_FROM_NAME || 'Alzaro GarageOps',
...
export function buildSmtpConfig(provider, credentials) {
  ...
  return {
    ...
    from: {
      name: credentials.fromName || 'Alzaro GarageOps',
...
<body>
  <div class="header">
    <div>
      <div class="logo">Alzaro<span>GarageOps</span></div>
  ...
  <div class="footer">
    Invoice generated by Alzaro GarageOps<br>
...
export async function sendInvoiceEmail(invoice, settings, lines, totals, preferredMethod = null) {
  ...
  const subject = `Invoice ${id} from ${settings.name || 'Alzaro GarageOps'}`
...
# Sender Details
VITE_SMTP_FROM_NAME=Alzaro GarageOps
