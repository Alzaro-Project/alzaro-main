...
//
//   * a different storageKey - so it can never overwrite alzaro-garageops-auth
...
export const SUPPORT_STORAGE_KEY = 'alzaro-garageops-support-auth'
...
function authConfig() {
  ...
  return {
    storageKey: 'alzaro-garageops-auth'
  }
}
...
export function createSupportClient() {
  return createClient(supabaseUrl, supabaseKey, {
    ...
    global: { headers: { 'x-product': 'garageops' } },
  })
}
