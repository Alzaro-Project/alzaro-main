...
const NAV = [
  ...
  { path: '/reports', icon: '📑', label: 'Reports', min: 'silver' },
...
export default function Sidebar({ onNavigate, isMobile }) {
  ...
  const handleNav = (item) => {
    // Always navigate — if the user lacks the required tier, the destination page's
...
<div style={{ fontSize: '10px', color: 'var(--text3)', fontFamily: 'JetBrains Mono, monospace', marginTop: '2px' }}>
  Garage Management Pro
      ...
      <div style={{ padding: '14px 16px', borderBottom: '1px solid var(--border)' }}>
        ...
        <div style={{
          ...
          borderRadius: '20px', fontSize: '11px', fontWeight: 700, fontFamily: 'JetBrains Mono, monospace',
