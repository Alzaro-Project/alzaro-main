...
// ------------------------------------------------------------
// Simplified: parts, labour and consumables tabs removed —
// Items is now just the services you offer, used by the
// invoice line dropdown and the booking form.
// ============================================================
    ...
    <div style={{ fontFamily: "'Space Grotesk', sans-serif", color: T.text }}>
      <div style={{ marginBottom: '20px' }}>
        ...
        <div style={{ fontSize: '13px', color: T.text2, marginTop: '2px' }}>
          The services you offer — set up once, used in invoices and bookings
        </div>
      </div>
