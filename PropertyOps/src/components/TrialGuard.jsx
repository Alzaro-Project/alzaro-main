  ...
  useEffect(() => {
    ...
    const fetchStatus = async () => {
      try {
        ...
        console.error("Failed to fetch PropertyOps status:", err);
      }
      setLoading(false);
    };
      ...
      return (
        <div style={wrap}>
          <div style={cardStyle}>
            ...
            <div style={{ color: "var(--txt-2)", marginBottom: 20, lineHeight: 1.6, fontSize: 13.5 }}>
              Your free trial has ended. Subscribe to continue using Alzaro PropertyOps and access all your data.
            </div>
            <a href="/propertyops/settings" style={{ display: "inline-block", background: "var(--brand)", color: "#fff", fontWeight: 700, fontSize: 13.5, padding: "12px 22px", borderRadius: 8, textDecoration: "none" }}>View plans</a>
