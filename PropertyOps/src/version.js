// PropertyOps version — single source of truth for the sidebar badge and the
...
//   3. Merge, then tag:  propertyops-v<VERSION>   e.g. propertyops-v1.1.0
//      (per-vertical tag — this app's versions move on their own. It's also
//       your rollback point; see ROLLBACK.md at the repo root.)
// This file is PropertyOps-only. Bumping it never touches other verticals.
