// TyreOps version — single source of truth for the sidebar badge and the
...
//   3. Merge, then tag:  tyreops-v<VERSION>   e.g. tyreops-v1.1.0
//      (per-vertical tag — this app's versions move on their own. It's also
//       your rollback point; see ROLLBACK.md at the repo root.)
// This file is TyreOps-only. Bumping it never touches other verticals.
