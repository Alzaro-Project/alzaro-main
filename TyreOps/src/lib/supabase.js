...
//
//   * a different storageKey - so it can never overwrite alzaro-tyreops-auth
...
export const SUPPORT_STORAGE_KEY = 'alzaro-tyreops-support-auth'
...
function authConfig() {
  ...
  return {
    storageKey: 'alzaro-tyreops-auth'
  }
}
...
export function createSupportClient() {
  return createClient(supabaseUrl, supabaseKey, {
    ...
    global: { headers: { 'x-product': 'tyreops' } },
  })
}
